...
metrics.append(pd.Series({'precision': precision, 'recall': recall,
                          'fscore': fscore, 'accuracy': accuracy, 'roc': roc_auc_score(y_test_prepared, y_pred_lr)},
                         name='lr'))
...
metrics.append(pd.Series({'precision': precision_svc, 'recall': recall_svc,
                          ...
                          'roc': roc_auc_score(y_test_prepared, y_pred_svc)},
                         name='SVC'))
print(metrics)
...
metrics.append(pd.Series({'precision': precision_knn, 'recall': recall_knn,
                          'fscore': fscore_knn, 'accuracy': accuracy_knn,  'roc': roc_auc_score(y_test_prepared, y_pred_knn)},
                         name='knn'))
print(metrics)
...
metrics.append(pd.Series({'precision': precision_tree, 'recall': recall_tree,
                          'fscore': fscore_tree, 'accuracy': accuracy_tree, 'roc': roc_auc_score(y_test_prepared, y_pred_tree)},
                         name='DTree'))
print(metrics)
...
metrics.append(pd.Series({'precision': precision_rf, 'recall': recall_rf,
                          'fscore': fscore_rf, 'accuracy': accuracy_rf, 'roc': roc_auc_score(y_test_prepared, y_pred_rf)},
                         name='RandomForest'))
print(metrics)
...
metrics.append(pd.Series({'precision': precision_extrTree, 'recall': recall_extrTree,
                          'fscore': fscore_extrTree, 'accuracy': accuracy_extrTree, 'roc': roc_auc_score(y_test_prepared, y_pred_extrTree)},
                         name='ExtraTrees'))
print(metrics)
...
metrics.append(pd.Series({'precision': precision_gboost, 'recall': recall_gboost,
                          'fscore': fscore_gboost, 'accuracy': accuracy_gboost, 'roc': roc_auc_score(y_test_prepared, y_pred_gboost)},
...
metrics.append(pd.Series({'precision': precision_aboost, 'recall': recall_aboost,
                          'fscore': fscore_aboost, 'accuracy': accuracy_aboost, 'roc': roc_auc_score(y_test_prepared, y_pred_aboost)},
                         name='AdamBoosting'))
print(metrics)
...
roc_nn1 = roc_auc_score(y_test_prepared, y_pred_knn1)

print(precision_nn1, recall_nn1, fscore_nn1, accuracy_nn1, roc_nn1)
...
roc_nn2 = roc_auc_score(y_test_prepared, y_pred_knn2)

print(precision_nn2, recall_nn2, fscore_nn2, accuracy_nn2, roc_nn2)
